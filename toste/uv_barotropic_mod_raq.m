function [ubar,vbar]=uv_barotropic_mod_raq(u,v,Hz,boundary);
...
% svn $Id: uv_barotropic.m 754 2015-01-07 23:23:40Z arango $
%===========================================================================%
...
%  Processing full grid.
  ...
  vbar=zeros(size(v(:,:,1)));
  for k=1:N,
    Duk=0.5.*(Hz(1:Lr,1:Mr,k)+Hz(1:Lr,1:Mr,k));
    Du=Du+Duk;
    Dvk=0.5.*(Hz(1:Lr,1:Mr,k)+Hz(1:Lr,1:Mr,k));
    Dv=Dv+Dvk;
